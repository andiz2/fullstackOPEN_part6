...
const anecdoteSlice = createSlice({
  ...
  initialState,
  reducers: {
    createAnecdote_toolkit(state, action){
    ...
    voteAnecdote_toolkit(state, action){
      ...
      console.log('state anec reducer',JSON.parse(JSON.stringify(state)))
...
export const {createAnecdote_toolkit, voteAnecdote_toolkit} = anecdoteSlice.actions
